...
//    var restaurantTypes = ["Coffee & Tea Shop", "Cafe", "Tea House", "Austrian / Causual Drink", "French", "Bakery", "Bakery", "Chocolate", "Cafe", "American / Seafood", "American", "American", "Breakfast & Brunch", "Coffee & Tea", "Coffee & Tea", "Latin American", "Spanish", "Spanish", "Spanish", "British", "Thai"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.NameLable.text = restaurant[indexPath.row].name
        cell.TypeLable.text = restaurant[indexPath.row].type
        cell.locationLable.text = restaurant[indexPath.row].location
        return cell
    }
    
     //MARK: - check in & call action
    ...
    // Mark:- Delete the row from the data source
//
...
//    }
    ...
    //Mark:- delete the row data source
...
//    override func prepare(for segue: UIStoryboardSegue, sender: Any?) { if segue.identifier == "Restaurant" {
